...
class MySQL_Add {
	...
	private function FileReader($fajl, $separator = ";") {
		...
		$sor_run = 0;
		$sql = "INSERT INTO `orthology_databases`(`faj1`, `uniprot1`, `faj2`, `uniprot2`, `percent`, `group`, `source`) VALUES ";
		$values = array("faj1", "uniprot1", "faj2", "uniprot2", "percent", "group", "source");
